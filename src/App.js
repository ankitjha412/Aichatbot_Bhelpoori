...
// const CLIENT_ID = 'glr8pul5frxqfns9efmgquplbv07i2'; // Replace with your Twitch Client ID
// const CLIENT_SECRET = 'uyyqqv9kvzf7q5td9zrprsjnqfhr3x'; // Replace with your Twitch Client Secret
  ...
  return (
    <div className="App">
      ...
      <header className="main-header">
        <h1>"Level Up Your World with Bulliverse Bot."</h1>
        <p>Where Gaming Meets Intelligence.</p>
        <h1 style={{fontSize:55}}>A New Epoch in <br></br> Web3 Gaming</h1>
